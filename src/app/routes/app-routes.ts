    ...
    children: [
      {
        ...
        loadComponent: () =>
        import('../layout/pages/main-page/main-page/main-page.component').then(
      ...
      },
      {
        ...
        loadComponent: () =>
        import('../layout/pages/create-balance-wheel/create-balance-wheel/create-balance-wheel.component').then(
          (c) => c.CreateBalanceWheelComponent,
        ),
      },
      {
